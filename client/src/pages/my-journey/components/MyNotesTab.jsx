...
export default function MyNotesTab() {
  ...
  return (
    <>
    <div className="w-full h-full rounded-2xl border border-[#c79c6e]/40 bg-[#0a0a0a]/70 backdrop-blur-sm p-4 sm:p-6 md:p-8 flex flex-col animate-in fade-in duration-700 mb-20 relative overflow-hidden group/notes hover:border-[#c79c6e]/60 transition-colors duration-500 hover:shadow-[0_0_50px_rgba(199,156,110,0.15)]">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6 mb-6 md:mb-8 relative z-10">
        <div className="flex flex-col gap-1.5 sm:gap-2">
          ...
          <div className="flex items-center gap-2 mt-2 sm:mt-4">
            ...
            <span className="font-sans text-[0.55rem] sm:text-[0.6rem] uppercase tracking-[0.2em] font-medium text-[#c79c6e]">
              ONLY VISIBLE TO YOU
            </span>
          </div>
        </div>
              ...
              <div className="flex flex-col justify-between items-start gap-3 sm:gap-4 w-full h-full">
                ...
                <div className="w-full flex items-center gap-3 pt-3 mt-1 border-t border-white/5">
                  <button 
                    ...
                    className="flex-1 py-2.5 sm:py-3 rounded border border-white/10 hover:border-[#c79c6e]/50 hover:bg-[#c79c6e]/5 text-white/70 hover:text-white font-sans text-[0.6rem] sm:text-[0.65rem] uppercase tracking-[0.15em] sm:tracking-[0.2em] font-medium transition-colors text-center"
                  >
                    OPEN
                  </button>
                  <button 
      ...
      <div className="flex justify-center mt-4 sm:mt-6 relative z-10">
        <button 
          ...
          className="flex items-center gap-2 font-sans text-[0.7rem] sm:text-[0.75rem] uppercase tracking-[0.15em] sm:tracking-[0.2em] font-medium text-[#c79c6e] hover:text-white transition-colors"
        >
