...
import { Gear, Key, FloppyDisk } from '@phosphor-icons/react';
...
export default function AdminSettings() {
  ...
  return (
    <div className="p-8 md:p-12 w-full max-w-4xl mx-auto flex flex-col gap-8 animate-in fade-in duration-500 font-sans">
      
      <div className="flex flex-col gap-2">
        <h1 className="font-serif text-3xl md:text-4xl text-white">System Settings</h1>
        <p className="font-sans text-sm text-white/50">Configure global application settings and integrations.</p>
      </div>

      <div className="bg-[#111] border border-white/5 rounded-2xl p-8 flex flex-col gap-6 relative shadow-2xl">
        <div className="flex items-center gap-3 text-[#c79c6e] border-b border-white/5 pb-4">
          <Gear size={24} />
          <h2 className="font-serif text-2xl text-white">Payment Gateway (Razorpay)</h2>
        </div>
